...
1. Bugs/PRs against ECMA-402
    ...
    5. Strip out u- key/value from locale returned by resolvedOptions() for those already in RelevantExtensionKeys [#311](https://github.com/tc39/ecma402/issues/311)
2. Stage 3 APIs
